...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2021 at 06:50 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getstation`()
    NO SQL
BEGIN
    select id,sname FROM station;
END$$
...
(12, 'Chandigarh', 'Jaipur', '2021-12-25', 'AC1', 2200, 107),
(12, 'Chandigarh', 'Jaipur', '2021-12-26', 'AC1', 3200, 20),
(12, 'Chandigarh', 'Jaipur', '2021-12-27', 'AC3', 2400, 60),
(12, 'Chandigarh', 'Jaipur', '2021-12-28', 'EC', 1200, 100),
(12, 'Chandigarh', 'Jaipur', '2021-12-29', 'SL', 500, 200),
...
(12, 'Jaipur', 'Kolkata', '2021-12-30', 'AC1', 1434, 243),
...
(12, 'Lucknow', 'Delhi', '2021-12-31', 'SL', 900, 179),
...
(61, 21, 6, 'Mumbai', 'Kolkata', '2021-12-26', 0, 'AC1', 1, 'BOOKED'),
(62, 21, 12, 'Lucknow', 'Mumbai', '2021-12-26', 0, 'AC1', 2, 'BOOKED'),
(63, 21, 12, 'Lucknow', 'Delhi', '2021-12-31', 900, 'SL', 1, 'BOOKED');
...
(20, 'chirag@nsitonline.com', 'chirag', '9123456789', '1990-06-02'),
(21, 'dee@gmail.com', 'dee', '9900912631', '1991-11-08');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user_view` AS select `user`.`emailid` AS `emailid`,`user`.`mobileno` AS `mobileno`,`user`.`dob` AS `dob` from `user`;
